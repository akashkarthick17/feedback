...
--
-- Table structure for table `fr__`
--

DROP TABLE IF EXISTS `fr__`;
...
--
-- Dumping data for table `fr__`
--

LOCK TABLES `fr__` WRITE;
/*!40000 ALTER TABLE `fr__` DISABLE KEYS */;
/*!40000 ALTER TABLE `fr__` ENABLE KEYS */;
UNLOCK TABLES;
